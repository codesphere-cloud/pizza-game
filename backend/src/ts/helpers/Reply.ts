...
export class Reply<T = never, S extends Status = Status> {
    ...
    public static createFromError(err: Error): Reply<never, Status.Error> {
        ...
        } as SerializedReply<never, Status.Error>, err.stack ?? new Error().stack as string);
    }
    ...
    /**
     * Only {@link log} if {@link code} equals {@link Status.ERROR}.
     */
    ...
    /**
     * Only throw a new error with the stack and message of this
